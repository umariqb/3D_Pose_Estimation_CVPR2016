function [returnFileName] =  H_text2MotFileUmH36Mbm_wtnn(dataName, strPath, savePath)
%% options to set
subject = 11;
...
%%
motIn.knnWts = impData.data';
motIn.bodyScale = str2num(char(impData.textdata{:,37}));
motIn.bodyType = str2num(char(impData.textdata{:,39}));
motIn.bodyType = motIn.bodyType + 1; % conversion c++ to matlab idx
motIn.bodyTypeOrder = {'pose';'upper'; 'lower'; 'right'; 'left'};
