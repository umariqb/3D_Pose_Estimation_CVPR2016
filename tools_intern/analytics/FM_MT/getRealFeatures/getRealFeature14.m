function [ scale, dataReal, thresh1, thresh2, dataBool ] = getRealFeature14( mot )
...
dataReal = feature_velPoint(mot,'lfingers','',100);
thresh1 = threshold_vel1 * humerus_length;
thresh2 = threshold_vel2 * humerus_length;

if nargout > 4
    dataBool = feature_AK_bool_handLeftHighVel_robust(mot);
end