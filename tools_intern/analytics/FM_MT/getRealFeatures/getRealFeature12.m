function [ scale, dataReal, thresh1, thresh2, dataBool ] = getRealFeature12( mot )
...
dataReal = feature_velRelPointNormalPlane(mot,'lwrist','root','lwrist','root');
thresh1 = threshold_vel1 * humerus_length;
thresh2 = threshold_vel2 * humerus_length;

if nargout > 4
    dataBool = feature_AK_bool_handLeftMoveApartRelRoot_robust(mot);
end