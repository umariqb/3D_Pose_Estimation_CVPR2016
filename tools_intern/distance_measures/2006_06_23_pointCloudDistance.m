function [d,theta,x0,z0] = pointCloudDistance(Ptraj,Qtraj,n,m,rho,theta,x0,z0)
...
if (nargin<8) % determine procrustes fit
    [theta_proc,x0_proc,z0] = procrustes2D(P,Q);
end
...
d = norm(P - (rotmatrix(theta,'y')*Q + repmat([x0;0;z0],1,K)),'fro');