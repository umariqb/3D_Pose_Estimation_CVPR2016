...
int C_setdiff_presorted(double* list_out, double* pA, double* pB, double mA, double mB, double* pIA, int* nIA)
{
	int		nOut = 0,
			iA = 0,
			iB = 0;
                 ...
                 int nrhs, const mxArray *prhs[])
{
  ...
  */
  ...
  mA = (mA>nA?mA:nA);
  mB = mB*nB; //(mB>nB?mB:nB);

  max_list_out_length = mA;  
  ...
  list_out_length = C_setdiff_presorted(list_out,pA,pB,mA,mB,pIA,&nIA);
