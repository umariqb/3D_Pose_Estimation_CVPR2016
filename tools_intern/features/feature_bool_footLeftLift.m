function feature = feature_bool_footLeftLift(mot,varargin)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
feature = dot(n,mot.jointTrajectories{trajectoryID(mot,'ltoes')}-mot.jointTrajectories{trajectoryID(mot,'root')}) + root_offset*femur_length;
