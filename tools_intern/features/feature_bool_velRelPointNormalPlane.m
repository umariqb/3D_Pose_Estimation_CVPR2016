function f = feature_bool_velRelPointNormalPlane(mot,p1_name,p2_name,p3_name,q_name,varargin)
% function f = feature_bool_velRelPointNormalPlane(mot,p1_name,p2_name,p3_name,q_name,varargin)
%
...
v = feature_velRelPointNormalPlane(mot,p1_name,p2_name,p3_name,q_name,win_len_ms);
b = v>0;
