function bool = feature_BD_bool_footLeftHighVel(mot, varargin)
...
bool =  threshold_vel1* humerus_length  < feature_BD_velRelPoint( mot, 'lankle', 'root', [] ) & threshold_vel1* humerus_length  < feature_BD_velRelPoint( mot, 'ltoes', 'root', [] );