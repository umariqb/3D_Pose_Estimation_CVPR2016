function bool = feature_BD_bool_handLeftToSide(mot, varargin)
...
bool =  threshold_vel1* humerus_length  < feature_BD_velRelPointNormalPlane( mot, 'neck', 'lshoulder', 'neck', 'lwrist', win_length_ms1 );