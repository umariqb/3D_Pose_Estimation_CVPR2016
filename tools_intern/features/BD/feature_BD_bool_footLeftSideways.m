function bool = feature_BD_bool_footLeftSideways(mot, varargin)
...
bool =  threshold_dist1* humerus_length  < feature_BD_distPointNormalPlane( mot, 'rhip', 'lhip', 'lhip', 'lankle' );