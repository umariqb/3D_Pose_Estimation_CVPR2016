function bool = feature_BD_bool_handLeftDownwards(mot, varargin)
...
bool =  threshold_vel1* humerus_length  < feature_BD_velRelPointNormalPlane( mot, 'neck', 'chest', 'chest', 'lwrist', win_length_ms1 );