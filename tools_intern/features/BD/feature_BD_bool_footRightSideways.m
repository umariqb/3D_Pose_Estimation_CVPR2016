function bool = feature_BD_bool_footRightSideways(mot, varargin)
...
bool =  threshold_dist1* humerus_length  < feature_BD_distPointNormalPlane( mot, 'lhip', 'rhip', 'rhip', 'rankle' );