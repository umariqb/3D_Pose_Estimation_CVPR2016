function bool = feature_BD_bool_footRightHighVel(mot, varargin)
...
bool =  threshold_vel1* humerus_length  < feature_BD_velRelPoint( mot, 'rankle', 'root', [] ) & threshold_vel1* humerus_length  < feature_BD_velRelPoint( mot, 'rtoes', 'root', [] );