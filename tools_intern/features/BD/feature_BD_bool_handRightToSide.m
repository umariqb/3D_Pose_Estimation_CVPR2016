function bool = feature_BD_bool_handRightToSide(mot, varargin)
...
bool =  threshold_vel1* humerus_length  < feature_BD_velRelPointNormalPlane( mot, 'neck', 'rshoulder', 'neck', 'rwrist', win_length_ms1 );