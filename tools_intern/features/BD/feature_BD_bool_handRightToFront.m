function bool = feature_BD_bool_handRightToFront(mot, varargin)
...
bool =  threshold_vel1* humerus_length  < feature_BD_velRelPointPlane( mot, 'neck', 'rhip', 'lhip', 'rwrist', win_length_ms1 );