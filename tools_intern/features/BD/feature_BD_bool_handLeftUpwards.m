function bool = feature_BD_bool_handLeftUpwards(mot, varargin)
...
bool =  threshold_vel1* humerus_length  < feature_BD_velRelPointNormalPlane( mot, 'chest', 'neck', 'neck', 'lwrist', win_length_ms1 );