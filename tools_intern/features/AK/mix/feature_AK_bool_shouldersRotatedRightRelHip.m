function bool = feature_AK_bool_shouldersRotatedRightRelHip(mot, varargin)
...
bool =  feature_distPointPlane( mot, 'rhip', 'lhip', 'neck', 'lshoulder' ) - feature_distPointPlane( mot, 'rhip', 'lhip', 'neck', 'rshoulder' ) > threshold_dist1* humerus_length ;