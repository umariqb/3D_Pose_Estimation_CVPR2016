function real = feature_AK_real_handLeftToTopRelSpine(mot, varargin)
...
real =  feature_velRelPointNormalPlane( mot, 'chest', 'neck', 'neck', 'lwrist', win_length_ms1 ) ./ femur_length;
% bool =  threshold_vel1* humerus_length  < feature_velRelPointNormalPlane( mot, 'chest', 'neck', 'neck', 'lwrist', win_length_ms1 );
