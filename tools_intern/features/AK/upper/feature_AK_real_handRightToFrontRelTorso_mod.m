function real = feature_AK_real_handRightToFrontRelTorso(mot, varargin)
...
real = feature_velRelPointPlane( mot, 'neck', 'rhip', 'lhip', 'rwrist', win_length_ms1 ) ./ femur_length;
% Anpassung an [0, 180]
real = (real+22)*180/44;
