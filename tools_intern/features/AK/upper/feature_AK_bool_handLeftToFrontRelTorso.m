function bool = feature_AK_bool_handLeftToFrontRelTorso(mot, varargin)
...
bool =  threshold_vel1* humerus_length  < feature_velRelPointPlane( mot, 'neck', 'rhip', 'lhip', 'lwrist', win_length_ms1 );