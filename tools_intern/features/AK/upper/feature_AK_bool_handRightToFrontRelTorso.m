function bool = feature_AK_bool_handRightToFrontRelTorso(mot, varargin)
...
bool =  threshold_vel1* humerus_length  < feature_velRelPointPlane( mot, 'neck', 'rhip', 'lhip', 'rwrist', win_length_ms1 );