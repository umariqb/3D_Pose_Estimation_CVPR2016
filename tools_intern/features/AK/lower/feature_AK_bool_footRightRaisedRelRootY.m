function feature = feature_AK_bool_footRightRaisedRelRootY(mot,varargin)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% feature = dot(n,mot.jointTrajectories{trajectoryID(mot,'rtoes')}-mot.jointTrajectories{trajectoryID(mot,'root')}) + root_offset*humerus_length;
feature = mot.jointTrajectories{trajectoryID(mot,'rtoes')}-mot.jointTrajectories{trajectoryID(mot,'root')} + root_offset*humerus_length;
