function feature = feature_AK_real_footLeftRaisedRelYBodyMin(mot,varargin)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
feature = mot.jointTrajectories{trajectoryID(mot,'ltoes')}(2,:) - minY - height*femur_length;
