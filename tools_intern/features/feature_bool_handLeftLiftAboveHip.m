function feature = feature_bool_handLeftLiftAboveHip(mot,varargin)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Tests if left wrist is located above the hip.
%
...
feature = feature_distPointNormalPlane(mot,'belly','root','root','lwrist') + spine_offset * belly_length;
feature = (feature >= 0);