function bool = feature_AK_bool_handRightToTopRelSpine(mot, varargin)
...
bool =  threshold_vel1* humerus_length  < feature_velRelPointNormalPlane( mot, 'neck', 'chest', 'neck', 'rwrist', win_length_ms1 );