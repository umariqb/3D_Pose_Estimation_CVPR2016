function feature = feature_BK_bool_lshoulder_2_lelbow_kinEnergy(mot)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
feature=BK_calc_dyn_feature(mot,'lshoulder_@_lelbow_E_kin','singleTresholdAdaptive',treshold);