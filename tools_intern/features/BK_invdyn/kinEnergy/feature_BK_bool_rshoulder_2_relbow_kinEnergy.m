function feature = feature_BK_bool_rshoulder_2_relbow_kinEnergy(mot)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
feature=BK_calc_dyn_feature(mot,'rshoulder_@_relbow_E_kin','singleTresholdAdaptive',treshold);