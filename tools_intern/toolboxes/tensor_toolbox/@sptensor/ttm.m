...
%   be a tensor (not an sptensor!) of the same order and size as X
...
% $Id: ttm.m,v 1.16 2007/01/10 01:27:31 bwbader Exp $
...
% Convert to sparse matrix and do the multiplication; result is a dense matrix
%TODO (after 2.0 release): Should we try to avoid forming this dense matrix?
Z = double(Xnt) * V';
