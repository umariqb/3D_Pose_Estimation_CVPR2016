function [Ppos,Pneg,Pboth] = testfisherexact(a,b,c,d)

% TESTFISHEREXACT computes the p-value of Fisher's exact test.
% -----------------------------------------------
% [pPos pNeg pBoth] = testfisherexact(a, b, c, d)
% -----------------------------------------------
% Description: computes the p-value of Fisher's exact test.
% Input:       {a,b,c,d} the four entries of the 2-by-2 contingency table
%                   a   b
%                   c   d
% Output:      {Ppos} p-value of the right-tail test.
%              {Pneg} p-value of the left-tail test.
%              {Pboth} p-value of the two-tail test.

% © see below
% Classification: Hypothesis testing
% Last revision date: 29-Apr-2006

% Author's description: Fisher's Exact Probability Test.
