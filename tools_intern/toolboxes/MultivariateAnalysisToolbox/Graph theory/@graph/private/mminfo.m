...
% MMINFO reads size and storage information of a Matrix Market file.
% -----------------------------------------------------
% [rows cols entries rep field symm] = mminfo(filename)
% -----------------------------------------------------
% Description: Reads the contents of the Matrix Market file 'filename', and
%              extracts size and storage information. In the case of
%              coordinate matrices, entries refers to the number of
%              coordinate entries stored in the file.  The number of
%              non-zero entries in the final matrix cannot be determined
%              until the data is read (and symmetrized, if necessary). In
%              the case of array matrices, entries is the product
%              rows*cols, regardless of whether symmetry was used to store
