...
% MMREAD reads the contents of the Matrix Market file into a matrix.
% -------------------------------------------------------
% [A rows cols entries rep field symm] = mmread(filename)
% -------------------------------------------------------
% Description: Reads the contents of the Matrix Market file 'filename' into
%              the matrix 'A'. 'A' will be either sparse or full, depending
%              on the Matrix Market format indicated by 'coordinate'
%              (coordinate sparse storage), or 'array' (dense array
%              storage).  The data will be duplicated as appropriate if
%              symmetry is indicated in the header. Optionally, size
%              information about the matrix can be obtained by using the
%              return values rows, cols, and entries, where entries is the
%              number of nonzero entries in the final matrix. Type
%              information can also be retrieved using the optional return
%              values rep (representation), field, and symm (symmetry).
