function plot_win_view_grouping(ud)

% PLOT_WIN_VIEW_GROUPING chooses a group that underlies viewing.
% --------------------------
% plot_win_view_grouping(ud)
% --------------------------
...
set(h_lb,'value',grp_view(2));
set(h_ed,'string',num2str(grp_view(3)));
