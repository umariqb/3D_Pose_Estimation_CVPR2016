function [ssX,Corco,It,Factors] = pftest(NumRep,X,Fac,Options,const,OldLoad,Weights);
...
% of replicate runs
%
% [ssX,Corco,It] = pftest(NumRep,X,Fac,Options,const,OldLoad,Weights);
%
...
if nargin==0
  ...
  disp(' ')
  disp(' I/O      : [ssX,Corco] = pftest(NumRep,X,Fac,Options,const,OldLoad,Weights);')
