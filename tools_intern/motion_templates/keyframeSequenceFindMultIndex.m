function [segments,framesTotalNum,matchStart,match] = keyframeSequenceFindMultIndex(template,keyframes,maxKeyframeSep,extendLeft,extendRight,indexArray)
% [segments,framesTotalNum,matchStart,match] = keyframeSequenceFindMultIndex(template,keyframes,maxKeyframeSep,extendLeft,extendRight,indexArray)
%
% INPUT:
% ------
% template ............ boolean motion template
% keyframes ........... 2xK array describing the positions and respective indexes for K keyframes: 
