...
VARS_GLOBAL_ANIM.figure_camera_file = ['cam_video_hits_jumpingJack'];

load hits_jumpingJack
...
%animateSimultaneous(hits,1,1,[],4,[4 0],'render/video_hits_jumpingJack.avi',4,30);
%animateSimultaneous(hits,1,1,[],4,[4 0],'render/video_hits_jumpingJack_slomo2.avi',2,30);
...
concatVideosSmooth_temporal(...
    {...
        ...
        'render/video_hits_jumpingJack.avi',...
        'render/video_hits_jumpingJack_slomo2.avi',...
        'render/video_hits_jumpingJack_slomo2.avi',...
},...
    'render/video_hits_jumpingJack_concat.avi',...
    {...
        [],...
        [],...
        [],...        
