...
if (render_video(1))
    for k=1:num_frames(1)
        ...
        grabVideoFrames(myfig,1,['render/video_template_elbowToKnee_allfeatures_bool.avi'],open_avi,close_avi);
    end
end
...
if (render_video(2))
    for k=1:num_frames(2)
        ...
        grabVideoFrames(myfig,1,['render/video_template_elbowToKnee_allfeatures_bool_padding.avi'],open_avi,close_avi);
    end
end
