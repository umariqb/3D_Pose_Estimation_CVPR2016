...
text(500,0.03,'Threshold \tau = 0.06','fontsize',12,'fontweight','bold','color','b');
...
for k=1:num_frames(1)
    if (render_video(1))
        ...
        grabVideoFrames(myfig,1,['render/video_delta_jumpingJack.avi'],open_avi,close_avi);
    end
end

% concatVideos_spatial({'render/video_hits_jumpingJack_concat.avi','render/video_delta_jumpingJack.avi'},'render/video_delta_hits_jumpingJack.avi','v')
  concatVideos_spatial({'render/video_template_jumpingJack_allfeatures_bool_padding.avi','render/video_delta_hits_jumpingJack.avi'},'render/video_jumpingJack_combined.avi','h')